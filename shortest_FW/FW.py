...
from drawfig import plot_RG_sd
#定义BPR计算路段阻抗
...
if __name__=="__main__":
    ...
    print('数据读取完毕！')
    Time, Flow, RGList, Flowall, Descent, buchanglist = FW(net, Time, Fftime, Capacity, Demand, k0=2000, eps=pow(10,-3))
    plot_RG_sd(RGList, 'FW', NETWORK)
#    Margin = {}
#    for l in Link:
